<aside id="admin-sidebar"
    ...
    <div class="flex-1 overflow-y-auto overflow-x-hidden py-6 px-4 group-[.is-collapsed]/sidebar:px-2 flex flex-col gap-1">
        ...
        <a href="{{ route('staff.delivery.dashboard') }}" title="Tổng quan"
            ...
            <i class="fa-solid fa-table-cells-large text-[18px] w-6 text-center shrink-0 {{ request()->routeIs('staff.delivery.dashboard') ? 'text-sidebar-active-text' : 'text-gray-400 group-hover/link:text-gray-600' }}"></i>
        ...
        <a href="{{ route('staff.delivery.orders.index', ['tab' => 'assigned']) }}" title="Đơn được giao"
            ...
            <i class="fa-solid fa-box text-[18px] w-6 text-center shrink-0 text-gray-400 group-hover/link:text-gray-600"></i>
        ...
        <a href="{{ route('staff.delivery.orders.index', ['tab' => 'shipping']) }}" title="Đang giao"
            ...
            <i class="fa-solid fa-truck-fast text-[18px] w-6 text-center shrink-0 text-gray-400 group-hover/link:text-gray-600"></i>
        ...
        <a href="{{ route('staff.delivery.orders.index', ['tab' => 'history']) }}" title="Lịch sử giao hàng"
            ...
            <i class="fa-solid fa-clock-rotate-left text-[18px] w-6 text-center shrink-0 text-gray-400 group-hover/link:text-gray-600"></i>
        ...
        <a href="{{ route('staff.delivery.profile.edit') }}" title="Hồ sơ cá nhân"
            ...
            <i class="fa-solid fa-user text-[18px] w-6 text-center shrink-0 {{ request()->routeIs('staff.delivery.profile.*') ? 'text-sidebar-active-text' : 'text-gray-400 group-hover/link:text-gray-600' }}"></i>
    ...
    <div class="p-4 border-t border-gray-100 flex flex-col gap-2 group-[.is-collapsed]/sidebar:px-2 group-[.is-collapsed]/sidebar:py-4">
        ...
        <button id="desktop-collapse-btn" title="Thu gọn Sidebar"
            ...
            <i class="fa-solid fa-angles-left text-[18px] transition-transform duration-300" id="collapse-icon"></i>
