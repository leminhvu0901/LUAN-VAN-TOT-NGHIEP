...
<div class="banners-page p-6 space-y-6 max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Thêm banner mới</h2>
            <p class="text-gray-500 text-sm mt-1">Tạo banner quảng cáo mới cho trang chủ.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl organic-shadow p-6 sm:p-8 border border-gray-100">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="title_tag" id="title_tag" value="{{ old('title_tag') }}" maxlength="50"
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
            ...
            <div>
                ...
                <div class="space-y-4">
                    <!-- Preview Container -->
                    <div id="image-preview-container" class="hidden w-full aspect-[2.3/1] sm:aspect-[4.9/1] rounded-2xl overflow-hidden border-2 border-dashed border-gray-200 relative group bg-gray-50">
                    ...
                    <!-- Upload Input Box -->
                    <div id="upload-placeholder" onclick="triggerFileInput();" class="w-full h-32 border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center gap-2 hover:border-emerald-500 hover:bg-emerald-50/10 cursor-pointer transition-all">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="display_order" id="display_order" value="{{ old('display_order') }}" min="0"
                        class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <span class="text-sm font-semibold text-gray-700">Kích hoạt hiển thị banner ngay lập tức</span>
            </div>
...
@push('scripts')
<script src="{{ asset('js/backend/banners/create.js') }}"></script>
@endpush
