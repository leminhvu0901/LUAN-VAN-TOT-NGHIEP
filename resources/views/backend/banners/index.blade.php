    ...
    <div class="banners-page p-6 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            ...
            <div class="flex flex-wrap items-center gap-2 sm:gap-3 w-full sm:w-auto justify-end">
                <button type="button" id="bulk-deselect-btn" onclick="deselectAllBanners();"
        ...
        <!-- Phần 2: Khung Thống kê (Mobile xếp 2 cột, Desktop xếp 5 cột) -->
        ...
        <div
            ...
            <div id="table-container" class="flex-1 flex flex-col min-h-0 relative w-full">
                ...
                <div id="banners-table-wrapper" class="flex-1 flex flex-col min-h-0 relative w-full">
                    @include('backend.banners.partials.table', ['banners' => $banners])
                </div>
            </div>
        </div>
...
@push('scripts')
    <script>
        // Định nghĩa endpoint cho JS dùng
        window.bannersRoutes = {
            index: "{{ route('admin.banners.index') }}",
                bulkDelete: "{{ route('admin.banners.bulk_delete') }}"
        };
    </script>
    <script src="{{ asset('js/backend/banners/index.js') }}"></script>
@endpush