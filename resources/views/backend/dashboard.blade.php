...
@section('content')
    <div class="dashboard-page p-4 md:p-6 space-y-6">
        ...
        <div class="space-y-3">
            ...
            @include('backend.dashboard.partials.action-cards')
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                <!-- Đơn hàng mới nhất -->
                @include('backend.dashboard.partials.recent-orders')

                <!-- Đánh giá mới nhất -->
                @include('backend.dashboard.partials.recent-reviews')
            </div>

            <!-- Cột phải: Cảnh báo kho & Hoạt động gần đây -->
            <div class="space-y-6">
                <!-- Cảnh báo kho -->
                @include('backend.dashboard.partials.stock-alerts')
