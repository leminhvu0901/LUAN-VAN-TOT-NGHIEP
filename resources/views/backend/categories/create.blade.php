...
<div class="p-6 space-y-6 max-w-4xl mx-auto">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Tạo danh mục sản phẩm mới để phân loại menu.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl organic-shadow p-6 sm:p-8 border border-gray-100">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required maxlength="20"
            ...
            <div>
                ...
                <input type="number" name="display_order" id="display_order" value="{{ old('display_order') }}" min="0"
                    class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-colors"
                    placeholder="Để trống sẽ tự động xếp vào cuối">
