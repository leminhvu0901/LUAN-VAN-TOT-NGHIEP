...
<head>
    ...
    // Cấu hình bảng màu Material Design 3 và font chữ Be Vietnam Pro cho Tailwind CSS Admin
    tailwind.config = {
        darkMode: "class",
        theme: {
            extend: {
...
<body class="flex h-screen overflow-hidden antialiased">
    ...
    // Thông báo Admin (SweetAlert2 helper)
    window.AdminAlert = {
    ...
    // Helper functions cho các trang danh sách admin
