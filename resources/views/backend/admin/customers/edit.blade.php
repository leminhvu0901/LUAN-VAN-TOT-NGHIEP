...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Xem trước ảnh đại diện mới và kiểm tra dung lượng tối đa 2MB
    if (avatarInput) {
    ...
    // Kiểm tra độ dài tối đa tên khách hàng khi chỉnh sửa
    ...
    // Kiểm tra định dạng email hợp lệ khi chỉnh sửa
    ...
    // Kiểm tra mật khẩu xác nhận trùng khớp khi đổi mật khẩu
    ...
    // Kiểm tra giới hạn điểm tích lũy tối đa khi chỉnh sửa
