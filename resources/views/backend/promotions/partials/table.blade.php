    ...
    <table class="w-full text-left border-collapse text-sm whitespace-nowrap">
        <thead class="bg-gray-50/80 border-b border-gray-100">
            <tr>
                ...
                <th class="px-6 py-4 font-semibold text-xs text-gray-500 uppercase tracking-wider">Mã / Mô tả</th>
                <th class="px-6 py-4 font-semibold text-xs text-gray-500 uppercase tracking-wider">Loại</th>
                <th class="px-6 py-4 font-semibold text-xs text-gray-500 uppercase tracking-wider">Giá trị</th>
                <th class="px-6 py-4 font-semibold text-xs text-gray-500 uppercase tracking-wider">Điều kiện</th>
                <th class="px-6 py-4 font-semibold text-xs text-gray-500 uppercase tracking-wider">Thời gian</th>
                <th class="px-6 py-4 font-semibold text-xs text-gray-500 uppercase tracking-wider">Lượt dùng</th>
        ...
        <tbody class="divide-y divide-gray-50">
            @forelse($promotions as $promo)
                ...
                <tr class="hover:bg-gray-50/50 transition-colors duration-200 group" id="promo-row-{{ $promo->id }}">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-col gap-0.5 max-w-[200px] whitespace-normal">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-col gap-1 max-w-[180px] whitespace-normal">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex flex-col gap-1 text-xs text-gray-600 max-w-[200px] whitespace-normal">
                            @if($promo->is_recurring)
                                @php
