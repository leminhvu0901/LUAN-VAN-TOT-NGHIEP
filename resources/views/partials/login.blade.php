        ...
        <div id="login-box" class="l-modal-box">
            ...
            <form action="#" method="POST">
                ...
                <div class="l-form-group">
                    <label class="l-label">Email hoặc Số điện thoại</label>
                    <input type="text" name="identity" placeholder="Nhập địa chỉ email hoặc số điện thoại" class="l-input" required>
                </div>

                <div class="l-form-group">
                    <label class="l-label">Mật khẩu</label>
                    <input type="password" name="password" placeholder="Nhập mật khẩu" class="l-input" required>
                </div>
            ...
            <!-- Google Button -->
            <button type="button" class="l-google-btn">
