    ...
    <div id="materials-imports-page" class="material-imports-page p-4 sm:p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <form action="{{ route('staff.materials.imports.store', $material->id) }}" method="POST" id="form-create-import">
                    @csrf
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <form action="{{ route('staff.materials.consume', $material->id) }}" method="POST" id="form-consume-stock">
                    @csrf
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const quantityInput = document.getElementById('create-import-quantity');
