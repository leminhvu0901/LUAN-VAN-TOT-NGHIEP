...
// Form "Cập nhật thông tin" và "Đổi mật khẩu" (desktop + mobile) giờ submit thật (tải lại trang).
// Lỗi validate hiện lại qua $errors ngay tại các ô <small id="name-error-desktop">... đã render sẵn
// trong Blade; riêng lỗi đổi mật khẩu thì Blade tự gọi showTab('password') sau khi tải lại trang
// (xem cuối resources/views/frontend/profile.blade.php) để mở đúng tab có lỗi.
