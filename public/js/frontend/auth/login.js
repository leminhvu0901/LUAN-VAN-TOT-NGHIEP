...
// Form đăng nhập submit thật (tải lại trang) — server redirect thẳng tới đích (trang chủ/dashboard
// tùy vai trò) nếu đúng, hoặc quay lại kèm lỗi ($errors->has('login_error')) nếu sai; khối
// DOMContentLoaded ở đầu file tự mở lại modal dựa vào data-show-login do Blade render từ session/lỗi.
