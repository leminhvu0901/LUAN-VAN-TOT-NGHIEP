...
class ReviewController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.reviews.index', compact('reviews', 'totalReviews', 'activeReviews', 'hiddenReviews'));
    }
    ...
    public function create()
    {
        ...
        $users = User::all();
        return view('backend.reviews.create', compact('products', 'users'));
    }
        ...
        if ($request->hasFile('new_images')) {
            ...
            foreach ($request->file('new_images') as $file) {
                ...
                if ($file->isValid()) {
                    ...
                    $file->move(public_path('images/reviews'), $imageName);
                    $images[] = $imageName;
                    $currentCount++;
                }
            }
