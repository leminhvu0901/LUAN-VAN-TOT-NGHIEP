...
class CustomerController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'html' =>  view('backend.admin.customers.partials.table', compact('customers'))->render()
            ]);
        }
    ...
    public function show($id)
    {
        ...
        return  view('backend.admin.customers.show', compact('customer', 'totalOrders', 'totalSpent', 'recentOrders'));
    }
