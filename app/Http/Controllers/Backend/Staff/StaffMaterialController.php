...
class StaffMaterialController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $html = view('staff.materials.partials.table', compact('materials'))->render();
            return response()->json([
                'html' => $html,
            ]);
        }

        return view('staff.materials.index', compact(
    ...
    public function imports(Material $material)
    {
        ...
        return view('staff.materials.imports', compact('material', 'imports', 'activeLotsCount'));
    }
    ...
    public function storeImport(Request $request, Material $material)
    {
        ...
        return redirect()->route('staff.materials.imports', $material)->with('success', 'Đã nhập kho thành công!');
    }
    ...
    public function consumeStock(Request $request, Material $material)
    {
        ...
        return redirect()->route('staff.materials.imports', $material)->with('success', 'Đã ghi nhận xuất kho sử dụng!');
    }
