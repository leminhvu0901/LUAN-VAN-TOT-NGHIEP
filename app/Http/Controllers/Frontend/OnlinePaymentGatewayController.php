 ...
 * thanh toán của đơn đó (vnpay) — tránh nhân đôi route/nút bấm cho mỗi cổng thanh toán mới thêm
...
class OnlinePaymentGatewayController
{
     ...
     *
     * Phản hồi trả về:
     * - Trả link chuyển hướng thanh toán (VNPay) cho JS xử lý tại màn hình POS
