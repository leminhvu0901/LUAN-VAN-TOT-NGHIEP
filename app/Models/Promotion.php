...
class Promotion extends Model
{
    ...
    {
        // KIỂM TRA KÊNH ÁP DỤNG, tại quầy / giao hàng, mã
        ...
        // KIỂM TRA SỐ LƯỢNG MÓN TỐI THIỂU vd: mã combo yêu
        ...
        // KIỂM TRA GIỚI HẠN TỔNG SỐ LƯỢT DÙNG TRÊN TOÀN HỆ THỐNG
        if ($this->usage_limit && $this->used_count >= $this->usage_limit) {
            return ['valid' => false, 'message' => 'Mã giảm giá đã hết lượt sử dụng.'];
        }

        // KIỂM TRA ĐIỀU KIỆN HẠNG THÀNH VIÊN, mã gắn cho
